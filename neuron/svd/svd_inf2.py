...
from nodes import NODE_CLASS_MAPPINGS, LoadImage, VAEDecode, KSampler
...
def main():
    ...
    with torch.no_grad():
        ...
        imageonlycheckpointloader = NODE_CLASS_MAPPINGS["CheckpointLoaderSimple"]()
        imageonlycheckpointloader_neuron = imageonlycheckpointloader.load_checkpoint(ckpt_name="svd_xt.safetensors")

        loadimage = LoadImage()
        loadimage_23 = loadimage.load_image(image="example.png")
        ...
        svd_img2vid_conditioning_12 = svd_img2vid_conditioning.encode(
            ...
            clip_vision=get_value_at_index(imageonlycheckpointloader_neuron, 3),
            init_image=get_value_at_index(loadimage_23, 0),
            vae=get_value_at_index(imageonlycheckpointloader_neuron, 2),
        )
        ...
        for q in range(10):
            videolinearcfgguidance_14 = videolinearcfgguidance.patch(
                min_cfg=1, model=get_value_at_index(imageonlycheckpointloader_neuron, 0)
            )
